"""
Django settings for BD_Gestion project.
...
SECRET_KEY = 'django-insecure-mp^n(=*5-u$d5cbxhl4^p46#+jk9*t#xd_$ia4k$_f*t7*m1g%'
...
WSGI_APPLICATION = 'BD_Gestion.wsgi.application'
